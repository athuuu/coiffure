...
class RdvPageCoiffeuses extends ConsumerStatefulWidget {
  const RdvPageCoiffeuses({Key? key}) : super(key: key);

  @override
  ConsumerState<RdvPageCoiffeuses> createState() => _RdvPageCoiffeusesState();
}

class _RdvPageCoiffeusesState extends ConsumerState<RdvPageCoiffeuses> {
  late List<RdvPageCoiffeuses> rdvs;
