import 'package:coiffeur/pages/infosprofil.dart';
import 'package:coiffeur/pages/secondepageprocess.dart';
      ...
      children: [
        ...
        Container(
          ...
          onPressed: () {
            Navigator.push(
              context, 
            MaterialPageRoute(builder: (context) => const Infosprofil()));
          },),
        ),
        const SizedBox(
          height: 40),
        const SizedBox(
          width: 300,
          child: Text(
            'Trouver une coiffeuse pour votre lissage',
                  ...
                  style: ButtonStyle(
                    ...
                    backgroundColor: MaterialStateProperty.all<Color>(secondarycolor)),
                      ...
                      onPressed: () {
                        Navigator.push( 
                          context,
                          MaterialPageRoute(builder: (context) => const TabBarMenusecond()),
                        );
                      },
                  ),
                ),
