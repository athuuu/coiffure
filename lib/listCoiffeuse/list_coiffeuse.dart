...
class ListPrestaCoiffeuse extends StatelessWidget {
  const ListPrestaCoiffeuse({Key? key}) : super(key: key);
          ...
          Expanded(
            child: Stack(children: <Widget>[
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => BigContenuCoiffeuse(
                  itemIndex: index,
...
class BigContenuCoiffeuse extends StatefulWidget {
  const BigContenuCoiffeuse({
    Key? key,
  ...
  @override
  State<BigContenuCoiffeuse> createState() => _BigContenuCoiffeuseState();
}

final _alertesRefCoiffeuses =
    FirebaseFirestore.instance.collection('alertescoiffeuses');

class _BigContenuCoiffeuseState extends State<BigContenuCoiffeuse> {
  final _alertes = _alertesRefCoiffeuses
